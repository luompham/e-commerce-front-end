          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className='text-end text-white mb-0'>Hotline:
                <a className='text-white' href="tel:(84) 363 522 969">(84) 363 522 969</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-5">
              <div className="input-group">
                <input
                  type="text"
                  className="form-control py-2" placeholder="Search Product Here..." aria-label="Search Product Here..." aria-describedby="basic-addon2" />
